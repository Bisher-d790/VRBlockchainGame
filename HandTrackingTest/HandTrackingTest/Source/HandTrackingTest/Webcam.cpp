...
void AWebcam::DoProcessing()
{
	// TODO: Do any processing here!
}

void AWebcam::UpdateTexture()
{
...
void AWebcam::UpdateTextureRegions(UTexture2D* Texture, int32 MipIndex, uint32 NumRegions, FUpdateTextureRegion2D* Regions, uint32 SrcPitch, uint32 SrcBpp, uint8* SrcData, bool bFreeData)
{
	if (Texture->Resource)
	{

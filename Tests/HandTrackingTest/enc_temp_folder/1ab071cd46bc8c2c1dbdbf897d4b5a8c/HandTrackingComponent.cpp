...
void UHandTrackingComponent::BeginPlay()
{
	...
	if (TextureRenderTarget) {
		ThresholdTrackerSizePixel = ThresholdTrackerSizePercentage * TextureRenderTarget->MaxTextureSize / 100;
...
bool UHandTrackingComponent::WritePixelsToArray(UTextureRenderTarget2D& RenderTarget, TArray<TArray<FColor>>& Bitmap2D)
{

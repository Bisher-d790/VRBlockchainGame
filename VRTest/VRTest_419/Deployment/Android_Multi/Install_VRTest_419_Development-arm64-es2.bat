...
%ADB% %DEVICE% install VRTest_419-arm64-es2.apk
...
%ADB% %DEVICE% push main.1.com.FYP.VRTest.obb %STORAGE%/obb/com.FYP.VRTest/main.1.com.FYP.VRTest.obb
if "%ERRORLEVEL%" NEQ "0" goto Error
...
%ADB% %DEVICE% shell pm grant com.FYP.VRTest android.permission.READ_EXTERNAL_STORAGE
%ADB% %DEVICE% shell pm grant com.FYP.VRTest android.permission.WRITE_EXTERNAL_STORAGE
@echo.
